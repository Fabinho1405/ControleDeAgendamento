                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <?php
                                $numero_fichas_liberadas = "SELECT * FROM controle_fichas  WHERE controle_fichas.id_func = $idfuncionario AND controle_fichas.id_extracao = 0 AND controle_fichas.id_status_sistema = 1";
                    ...
                    <?php
                            if(!empty($_POST['enviar'])){
                                ...
                                if(empty($tipo)){
                                    ...
                                    if($tipo == 1){                                       
                                        $pesquisa_ficha = "SELECT * FROM cliente WHERE id_func = '$idfuncionario' AND nome_cliente LIKE '%$parametro%'";
                        ...
                        <?php  
                            ...
                            echo "<a href='reagendar_cliente.php?id=$idcliente&nome_cliente=$nomemodelo&telefone_cliente=$telefoneprincipal&nome_responsavel_cliente=$responsavel'> Agendar </a>";
                        ?> </td>
                      </tr>
                        <?php
                                        };
                                        ...
                                        $pesquisa_ficha = "SELECT * FROM cliente WHERE id_func = '$idfuncionario' AND telefone_cliente LIKE '%$parametro%'";
                                        $result_parametro = mysqli_query($conn, $pesquisa_ficha);
                                        while($row_parametro = mysqli_fetch_assoc($result_parametro)){
                        ?>
                                        <tr>
