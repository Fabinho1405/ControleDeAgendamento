                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <?php
                                $numero_fichas_liberadas = "SELECT * FROM controle_ligacao WHERE id_func = '$idfuncionario' AND id_status_sistema = '1' AND id_extracao = '0' AND liberado_controle_externo = '0' AND date(data_liberada_stand_by) = date(NOW()) ORDER BY qtd_feedback, id_controle ASC LIMIT 1";
                            ...
                            ?>
                            <strong class="card-title">Lista</strong> Telefônica - Total de Fichas: <?php echo $qtd_final_fichas_liberadas; ?>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        ...
                        <?php  
                             $result_total_1_fb = "";                       
                            $result_usuarios = "SELECT * FROM controle_ligacao WHERE id_func = '$idfuncionario' AND id_status_sistema = '1' AND id_extracao = '0' AND liberado_controle_externo = '0' AND date(data_liberada_stand_by) = date(NOW()) ORDER BY qtd_feedback, id_controle ASC LIMIT 1";                            
