                ...
                <div class="col-lg-6">
                    <div class="card" style="max-width: 900px; width: 800px;">
                      ...
                      <div class="card-body card-block">
                        <form action="actions/act_cadastrar_agendamento_insta.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" maxlength="11" id="text-input" name="telefoneprincipal" placeholder="NÃO utilize nenhum tipo de carácter não numérico nem espaços." class="form-control" value="<?php 
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" maxlength="11" id="text-input" name="telefonesecundario" placeholder="" class="form-control" value="<?php 
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="email" id="email-input" name="email" placeholder="" class="form-control" value="<?php echo $row_usuario['email_cliente']; ?>"><small class="help-block form-text"></small></div>
                          </div>               
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              <select name="select_conta" id="select" class="form-control">
                                <?php 
                                    $result_contas_insta = "SELECT id_conta_utilizada, nome_conta_utilizada FROM conta_utilizada WHERE id_func = '$idfuncionario' AND status = '1'"; 
                          ...
                          <div class="row form-group">
                           ...
                           <div class="row form-group">
                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">User:<b><font color="red">*</font></b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Instagram.com/</label></div>
                          ...
                          <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label">Local Captado:<b><font color="red">*</font></b></label></div>
                            <div class="col-12 col-md-9">
                              
                              <select name="select_local_captado" id="select" class="form-control">
                                <?php 
                                    $result_locais = "SELECT * FROM lugares_captados WHERE status_lc = '1' ORDER BY desc_lc ASC"; 
                                    $resultado_locais = mysqli_query($conn, $result_locais);
                                    while($row_locais = mysqli_fetch_assoc($resultado_locais)){ 
                                ?>
                                <option value="<?php echo $row_locais['id_lc']; ?>"><?php echo $row_locais['desc_lc'];  ?></option>
                               <?php
                                    };
                               ?>
                              </select>
