...
<!--  INICIO PAGE  -->
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <?php 
                          $result_agendamento = "SELECT * FROM agendamentos ag
                            ...
                            WHERE ag.id_status_auditoria = '1' ORDER BY ag.data_cadastro_agendamento ASC LIMIT $inicio, $qnt_result_pg ";
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><center><?php  echo "<a href=actions/act_registra_log.php?idagdm=".$row_agendamento['id_agendamentos']."&acao=1><img src='images/audit.png' width='48px' height='48px' title='Auditar Agendamento'></a>"; ?></center>
                        </td>                           
                      </tr>
                    </tbody>
                    <?php }; ?>
        ...
        $result_pg = "SELECT COUNT(id_agendamentos) AS num_result FROM agendamentos ag
                            ...
                            INNER JOIN cliente cli ON ag.id_cliente = cli.id_cliente
                            INNER JOIN conta_utilizada cu ON ag.id_conta_utilizada = cu.id_conta_utilizada
                            WHERE ag.id_status_auditoria = '1' ORDER BY ag.data_cadastro_agendamento ASC";
        ...
        $max_links = 10;
        echo "<a href='auditar_agendamento.php?pagina=1'>Primeira</a> ";
        
        for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
            if($pag_ant >= 1){
                echo "<a href='auditar_agendamento.php?pagina=$pag_ant'>$pag_ant</a> ";
            }
        }
        ...
        for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
            if($pag_dep <= $quantidade_pg){
                echo "<a href='auditar_agendamento.php?pagina=$pag_dep'>$pag_dep</a> ";
            }
        }
        
        echo "<a href='auditar_agendamento.php?pagina=$quantidade_pg'>Ultima</a>";
