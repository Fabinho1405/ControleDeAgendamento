...
<!--  INICIO PAGE  -->
                    ...
                    <thead>
                      <tr>
                        ...
                        <?php  
                            ...
                            WHERE agend.id_func = '$idfuncionario'AND agend.id_meio_captado = '4' ORDER BY id_agendamentos DESC LIMIT $inicio, $qnt_result_pg ";
        ...
        $result_pg = "SELECT COUNT(id_cliente) AS num_result FROM cliente WHERE id_func = $idfuncionario AND id_meio_captado = '4'";
        ...
        $max_links = 10;
        echo "<a href='visualizar_agendamento_facebook.php?pagina=1'>Primeira</a> ";
        
        for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
            if($pag_ant >= 1){
                echo "<a href='visualizar_agendamento_facebook.php?pagina=$pag_ant'>$pag_ant</a> ";
            }
        }
        ...
        for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
            if($pag_dep <= $quantidade_pg){
                echo "<a href='visualizar_agendamento_facebook.php?pagina=$pag_dep'>$pag_dep</a> ";
            }
        }
        
        echo "<a href='visualizar_agendamento_facebook.php?pagina=$quantidade_pg'>Ultima</a>";
