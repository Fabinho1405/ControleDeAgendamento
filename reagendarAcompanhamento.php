                ...
                <div class="col-lg-6">
                    <div class="card" style="max-width: 900px; width: 800px;">
                      ...
                      <div class="card-body card-block"> 
                        ...
                        ?> 
                        <form action="actions/actReagendarClienteAcompanhamento.php?ag=<?php echo $_GET['ag']; ?>&cli=<?php echo $_GET['cli']; ?>&conf=<?php echo $conf; ?>&funcAg=<?php echo $idScouterReagendamento; ?>&meioCap=<?php echo $meioCaptado ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
