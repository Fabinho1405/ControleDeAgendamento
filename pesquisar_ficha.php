                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <?php
                                $numero_fichas_liberadas = "SELECT * FROM controle_fichas  WHERE controle_fichas.id_func = 999 AND controle_fichas.id_extracao = 0 AND controle_fichas.id_status_sistema = 1 AND controle_fichas.modalidade = 2";
                            ...
                            ?>
                            <strong class="card-title">Lista</strong> Whattsapp - Fichas Rotativas: <?php echo $qtd_final_fichas_liberadas; ?>
                        </div>
                        <div class="card-body">
                            <center>
                    ...
                    <?php
                            if(!empty($_POST['enviar'])){
                                ...
                                if(empty($tipo)){
                                    ...
                                    if($tipo == 1){
                                        $pesquisa_ficha = "SELECT * FROM controle_fichas WHERE  id_extracao = '0' AND modalidade = '2' AND nome_responsavel_controle LIKE '%$parametro%'";
                        ...
                        <?php  
                            ...
                            echo "<a href='cadastrar_agendamento_wts.php?idcontrole=$idficha&nomemodelo=$nomemodelo&telefoneprincipal=$telefoneprincipal&telefonesecundario=$telefonesecundario&nomeresponsavel=$responsavel'> Agendar </a>";
                        ?> </td>
                      </tr>
                        <?php
                                        };
                                    }else if($tipo == 2){
                                        $pesquisa_ficha = "SELECT * FROM controle_fichas WHERE id_extracao = '0' AND modalidade = 2 AND telefone_principal_controle LIKE '%$parametro%'";
                                        $result_parametro = mysqli_query($conn, $pesquisa_ficha);
                                        while ($row_parametro = mysqli_fetch_assoc($result_parametro)){
                    ?>
                        <tr>
