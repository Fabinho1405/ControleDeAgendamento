<?php                         
                            ...
                            // Cadastrar o Cliente
                            $inserir_cliente = "INSERT INTO cliente (nome_cliente, telefone_cliente,telefone2_cliente,idade_cliente,nome_responsavel_cliente, id_meio_captado, data_cadastro_cliente,id_func) VALUES ('$nome_modelo','$telefone_principal','$telefone_secundario','$idade','$nome_responsavel','2',NOW(),'$idfuncionario')";
                            ...
                            $_SESSION['msgcad'] = "<div class='alert alert-success' role='alert'>
                             ...
                             //LOG
                                        ...
                                        $idfuncionario = $_SESSION['id_usuario'];
                                        $insert_log = "INSERT INTO logs (datetime_log, ip_user, mensagem_log, tipo_log, id_func) VALUES (NOW(), '$ip_log', 'agendamento WTS encaminhado para auditoria -> CLI: $id_new_cliente', 'ALERTA', '$idfuncionario');";
                                        $exec_insert_log = mysqli_query($conn, $insert_log);
                            //FIM LOG

                            header("Location:../cadastrar_agendamento_wts.php");
                        }
