<?php
    ...
    if($linhaAutentica->func_recuperacao == $idFuncionario){
        ...
        //$desativaAgendamento->bindValue(":semInteresseRecuperacao", $motivo); 
    	$desativaAgendamento->execute();

    	//Insere o Agendamento
    	$insereAgendamento=$pdo->prepare("INSERT INTO agendamentos (data_agendada_agendamento, hora_agendada_agendamento, data_cadastro_agendamento, id_cliente, id_status_sistema, id_func, id_comparecimento,id_unidade, reagendado, reagendadoRecuperacao, id_meio_captado) VALUES (:dataAgendado,:horaAgendado,NOW(),:idCliente,1,:idFuncionario,3,:idUnidade, 1, 1, 3)");
        ...
        header("Location: ../reagendarRecuperacao.php");
    }else{
