                ...
                <div class="col-lg-6">
                    <div class="card" style="max-width: 900px; width: 800px;">
                      <div class="card-header" style="max-width: 900px; width: 800px;">
                        <strong>Encaminhamento </strong> de Modelo para Trabalhos
                      </div>
                      <?php
                    ...
                    ?>
                      <div class="card-body card-block">
                        <form action="actions/act_cadastrar_ts.php?tp=2" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">
                            <div class="col-12 col-md-12">Olá Produtor! <br> Encaminhe seu modelo para trabalhos.</div>
                          </div>  
                          <div class="row form-group">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                ...
                                <?php
                                    $pesquisar_funcionarios = "SELECT * FROM marcas WHERE trabalho = '1' ORDER BY descricao_marcas ASC";
                          ...
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Selecione o Tipo de Cachê:</label></div>
                            <div class="col-12 col-md-9">
                                <select name="tipo_cache_ts" class="form-control">                    
                                    <option value="1">À Pagar</option>
                                    <option value="2">Abater</option>
                          ...
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Valor:<b><font color="red">*</font></b> </label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="valor_ts" placeholder="" class="form-control"><small class="form-text text-muted"></small></div>
                          </div>               
