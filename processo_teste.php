                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Você</strong> está fotografando o teste do cliente abaixo. <small>Não esqueça da finalização quando terminar o ensaio.</small>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        ...
                        <?php         
                            ...
                            $result_procedimento = "SELECT * FROM procedimento_diario pd INNER JOIN cliente cli ON pd.id_cliente = cli.id_cliente WHERE pd.procedimento = '1' AND pd.processo_teste = '1' AND pd.produtor_procedimento = '$idfuncionario' LIMIT 1";
                    ...
                    <tbody>
                      <tr>
                        <td><font size="5px"><?php  echo $row_procedimento['id_pd']; ?></font></td>
                        ...
                        echo "<center><a href='actions/act_procedimento_diario.php?pcdm=4&idpcdm=$idprocedimento'>Encaminhar para Resultado</a></center>" 
                        ?></td>
                      </tr>
                    </tbody>
                    <?php
