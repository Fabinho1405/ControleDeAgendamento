                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Clientes</strong> aguardando para tirar fotos para o Teste. &nbsp;&nbsp;&nbsp; <small>Selecione um para atender.</small>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        ...
                        <?php  
                            ...
                            $result_procedimento = "SELECT * FROM procedimento_diario pd INNER JOIN cliente cli ON pd.id_cliente = cli.id_cliente WHERE pd.procedimento = '1' AND pd.processo_teste = '0' AND pd.libera_teste = '1' ORDER BY pd.id_pd ASC";
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><?php  echo $row_procedimento['final_procedimento'];
                            ?></td>         

                        <td><?php 
                        $idprocedimento = $row_procedimento['id_pd'];
                        echo "<a href='actions/act_procedimento_diario.php?pcdm=3&idpcdm=$idprocedimento'>Chamar Para Teste</a>" 
                        ?></td>
                      </tr>
                    </tbody>
                    <?php
