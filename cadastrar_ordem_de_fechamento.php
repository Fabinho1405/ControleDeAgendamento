                        ...
                        <form action="actions/act_registrar_ordem_fechamento.php?un=<?php echo $unidadefunc ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">                  
                                    <input type="text" id="email-input" name="nome_modelo" placeholder="" class="form-control" value="<?php if(!empty($nomemodelo)){echo $nomemodelo;}else{} ?>">
                                </div>
                            </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="responsavel_modelo" placeholder="" class="form-control" value="">
                            </div>       
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="telefoneprincipal_modelo" placeholder="" class="form-control" value="">
                            </div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="telefonesecundario_modelo" placeholder="" class="form-control" value="">
                            </div>
                          </div>                           
