                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST">
                                ...
                                <input type="radio" name="filtro" value="3"> URL Instagram
                                <br>
                    ...
                    if(!empty($_POST['enviar'])){
                        ...
                        if(empty($tipo)){
                            ...
                            if($tipo == 1){                                       
                                $pesquisa_ficha = "SELECT * FROM cliente cli INNER JOIN funcionario fun  ON cli.id_func = fun.id_func WHERE cli.nome_cliente LIKE '%$parametro%' OR cli.nome_responsavel_cliente LIKE '%parametro%' LIMIT 15";
                    ...
                    ?>
                                    <tr>
                                        ...
                                        echo "<a href='historico_cliente.php?idcli=$idcliente'><img src='images/show.png' width='48px' height='48px' ></a>"; ?></td>
                                    </tr>

                    <?php
                                }
                            }else if($tipo == 2){
                                $pesquisa_ficha = "SELECT * FROM cliente cli INNER JOIN funcionario fun ON cli.id_func = fun.id_func WHERE cli.telefone_cliente LIKE '%$parametro%' OR cli.telefone2_cliente LIKE '%parametro%' LIMIT 15";
                                $result_parametro = mysqli_query($conn, $pesquisa_ficha);
                                while($row_parametro = mysqli_fetch_assoc($result_parametro)){
                    ?>
                                    <tr>
                    ...
                    <?php
                                ...
                                $pesquisa_ficha = "SELECT * FROM cliente cli INNER JOIN funcionario fun ON cli.id_func = fun.id_func WHERE cli.url_instagram LIKE '%$parametro%' LIMIT 15";
                                $result_parametro = mysqli_query($conn, $pesquisa_ficha);
                                while($row_parametro = mysqli_fetch_assoc($result_parametro)){
                    ?>
                                    <tr>
