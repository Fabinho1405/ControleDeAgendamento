                ...
                <div class="col-lg-6">
                    <div class="card" style="max-width: 900px; width: 800px;">
                      <div class="card-header" style="max-width: 900px; width: 800px;">
                        ...
                        -->
                        <strong>Cadastro</strong> de Agendamento Facebook                      
                      </div>
                      <div class="card-body card-block">
                        <form action="actions/act_cadastrar_agendamento_facebook.php?<?php 
                        ...
                        ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                          <div class="row form-group">
                              <div class="col col-md-3"><label for="text-input" class=" form-control-label">URL do Face: fb.com/</label></div>
                              <div class="col-12 col-md-9"><input type="text" id="text-input" name="url_face" placeholder="" class="form-control" value="<?php
