                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Acompanhamento Individual <small>Nesta aba, você fará seus acompanhamentos no dia de seu agendamento. Boa Sorte :)</small></strong>
                        </div>
                        <div class="card-body">
                    ...
                    <thead>
                      <tr>
                        ...
                        <?php  
                            $dia_confirmacao = date("Y-m-d");

                            $result_num_agendados = "SELECT * FROM agendamentos WHERE data_agendada_agendamento = '$dia_confirmacao' AND id_unidade = '$unidade' AND id_func = '$idfuncionario'";
                            $resultado_num_agendados = mysqli_query($conn, $result_num_agendados);
                            $qtd_agendados = mysqli_num_rows($resultado_num_agendados);

                            $result_num_confirmados_conf1 = "SELECT * FROM agendamentos WHERE data_agendada_agendamento = '$dia_confirmacao' AND id_unidade = '$unidade' AND id_comparecimento = '3' AND confirmado = '1' AND id_func = '$idfuncionario' ";     
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <!-- COMEÇO DA MERDA -->                
                       <?php 
                            ...
                            $confirmacao_p_tentativa = "SELECT * FROM agendamentos ag INNER JOIN cliente cli ON ag.id_cliente = cli.id_cliente WHERE data_agendada_agendamento = '$dia_confirmacao' AND id_unidade = '$unidade' AND acp_1 = '1' AND id_status_sistema = '1' AND ag.id_func = '$idfuncionario' ORDER BY ag.hora_agendada_agendamento ASC";
                            ...
                            ?>
                                ...
                                <tbody>
                                   <tr>
                                    ...
                                    <td>
                                        <form name="contato" action="actions/modificar_acompanhamento.php?dataconfirmacao=<?php echo $dia_confirmacao; ?>&idagendamento=<?php echo $row_conf['id_agendamentos']; ?>&fb=1&cli=<?php echo $row_conf['id_cliente']; ?>" method="POST">
                            ...
                            ?>
                                ...
                                <tbody>
                                   <tr>
                                    ...
                                    <td><?php echo $row_conf['hora_agendada_agendamento']; ?></td>
                                    <td>
                                        <form name="contato" action="actions/modificar_acompanhamento.php?dataconfirmacao=<?php echo $dia_confirmacao; ?>&idagendamento=<?php echo $row_conf['id_agendamentos']; ?>&fb=2&cli=<?php echo $row_conf['id_cliente']; ?>" method="POST">
                            ...
                            ?>
                                ...
                                <tbody>
                                   <tr>
                                    ...
                                    <td><?php echo $row_conf['hora_agendada_agendamento']; ?></td>
                                    <td>
                                        <form name="contato" action="actions/modificar_acompanhamento.php?dataconfirmacao=<?php echo $dia_confirmacao; ?>&idagendamento=<?php echo $row_conf['id_agendamentos']; ?>&fb=3&cli=<?php echo $row_conf['id_cliente']; ?>" method="POST">
                                        <select name="status_confirmacao" class="form-control">
                                            <option value="1">Em Aberto</option>
                                            <option value="2">Confirmou</option>
                                            <option value="3">Reagendou</option>
...
INNER JOIN cliente cli ON ag.id_cliente = cli.id_cliente WHERE data_agendada_agendamento = '$dia_confirmacao' AND id_unidade = '$unidade' AND confirmado = '0' AND ag.id_func = '$idfuncionario' AND DATEDIFF( data_agendada_agendamento, data_cadastro_agendamento) > '1' ";
