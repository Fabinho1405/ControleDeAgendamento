                    ...
                    <div class="card" style="max-width: 900px; width: 800px;">
                      <div class="card-header" style="max-width: 900px; width: 800px;">
                        ...
                        <?php
                            ...
                            WHERE id_agendamentos = '$idagendamento' AND ag.id_func = '$idfuncionario'";
                            $exec_select_agendamento = mysqli_query($conn, $select_agendamento);
                            $row_agendamento = mysqli_fetch_assoc($exec_select_agendamento);

                        ?>                       
                        <strong>Solicitar</strong> Re-Análise de Agendamento                       
                      </div>
                      <div class="card-body card-block">
                        <form action="actions/act_solicitar_reanalise.php?idagdm=<?php echo $idagendamento; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              <textarea cols="80" rows="10" name="motivo" style="resize: none;" class="form-control" placeholder="Digite o motivo de sua solicitação ...">
                      ...
                      <input type="submit" name="envio" value="Solicitar Re-Análise" class="btn btn-outline-warning btn-sm">
