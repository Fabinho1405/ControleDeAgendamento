...
class Authenticator {
  ...
  public static $username = "ResCPT";
  public static $password = "concept201920201";
...
<?php
echo "<meta HTTP-EQUIV='refresh' CONTENT='20;URL=resumo_cpt.php'>";
?>
</head>
<body bgcolor="#696969">
<?php
...
<thead>
  <tr>
   ...
   <?php 
      ...
      $final_operador = '0';
      $cont_op = '1';
      $consult_funcionarios = "SELECT * FROM funcionario WHERE id_unidade = '4' ORDER BY id_unidade ASC";
