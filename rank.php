...
<?php
	...
	$selecionar_func = "SELECT * FROM funcionario";
	...
	while($row_funcionario = mysqli_fetch_assoc($selecionar_func_query)){
		...
		$pegar_qtd_agendados = "SELECT * FROM agendamentos WHERE id_func = '$id_func' AND reagendado = '0' AND DATE(data_cadastro_agendamento) BETWEEN '$data_inicial' AND '$data_final'";
		$pegar_qtd_reagendados = "SELECT * FROM agendamentos WHERE id_func = '$id_func' AND reagendado = '1' AND DATE(data_cadastro_agendamento) BETWEEN '$data_inicial' AND '$data_final'";
