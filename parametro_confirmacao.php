                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Parâmetro</strong> de Confirmação
                        </div>
                       <div class="card-body card-block">
                        <form action="confirmacao.php" method="GET" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label">Método:<b><font color="red">*</font></b></label></div>
                            <div class="col-12 col-md-9">
                              <select name="select_metodo" id="select" class="form-control">                                
