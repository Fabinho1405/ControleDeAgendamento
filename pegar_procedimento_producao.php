...
<head>
    ...
    <?php
        echo "<meta HTTP-EQUIV='refresh' CONTENT='20;URL=pegar_procedimento_producao.php'>";
    ?>
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                      ...
                      <tr>
                        ...
                        if($unidade == 4){
                            $procedimento = "SELECT * FROM estudio_concept ec 
                                ...
                                WHERE ec.liberado_espera_producao_ec = '1' ORDER BY id_ec ASC";
                            ...
                            $procedimento = "SELECT * FROM estudio_exclusive ec 
                                ...
                                INNER JOIN motivo_estudio me ON me.id_me = ec.id_motivo_estudio
                                INNER JOIN marcas ma ON ma.id_marcas = ec.id_marca_sel_trab
                                WHERE ec.liberado_espera_producao_ec = '1' AND date(ec.created)=date(NOW())  ORDER BY ec.id_ec ASC";
                            $resultado_procedimento = mysqli_query($conn, $procedimento);
                            $qtd_resultado_procedimento = mysqli_num_rows($resultado_procedimento);
                        }
                    ...
                    <tbody>
                      <tr>
                        ...
                        echo "<a href='actions/act_procedimento_estudio.php?acp=$idprocedimento&etp=3'>Atender Cliente</a>" 
                        ?></td>
                      </tr>
                    </tbody>
                    <?php
