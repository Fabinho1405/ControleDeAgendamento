                ...
                <div class="col-lg-6">
                    <div class="card" style="max-width: 900px; width: 800px;">
                      ...
                      <div class="card-body card-block">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              <?php
                                echo $row_agendamento['telefone_cliente']."-(".strlen($row_agendamento['telefone_cliente']).") - <a href='http://www.qualoperadora.net?telefone=".$row_agendamento['telefone_cliente']."' target='_blank'> Localizar </a>";
                              ?>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              ...
                              if(!empty($row_agendamento['telefone2_cliente'])){
                                echo $row_agendamento['telefone2_cliente']."-(".strlen($row_agendamento['telefone2_cliente']).") - <a href='http://www.qualoperadora.net?telefone=".$row_agendamento['telefone2_cliente']."' target='_blank'> Localizar </a>";
                              }else{
                                echo "Não Possui";
                              }
                          ...
                          <div class="row form-group">
                           ...
                           <div class="row form-group">
                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label"><b>Link:</b><b><font color="red"></font></b></label></div>
                            <div class="col-12 col-md-9">
                              <?php
                                $instagram = $row_agendamento['url_instagram'];
                                if($row_agendamento['id_conta_utilizada'] == 753){
                                  echo "Agendamento WTS";
                                }else if($row_agendamento['id_conta_utilizada'] == 767){
                                echo $instagram." | <a href='http://www.fb.me/$instagram/' target='_blank'>Acessar Face</a>";
                              }else{
                                echo $instagram." | <a href='http://www.instagram.com/$instagram/' target='_blank'>Acessar Insta</a>";
                              }
                              ?>                              
                            </div>
                          </div>                           
                      ...
                      <div class="card-footer">
                        ...
                        <a href="<?php echo 'actions/act_auditoria_agendamento.php?dec=1&idagdm='.$idagendamento.''?>">
