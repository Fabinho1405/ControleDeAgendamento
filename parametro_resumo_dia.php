                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Parâmetro</strong> de Relatório Diário
                        </div>
                       <div class="card-body card-block">
                        <form action="resumo_diario_detalhes.php" method="GET" enctype="multipart/form-data" class="form-horizontal">
