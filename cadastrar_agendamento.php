                ...
                <div class="col-lg-6">
                    <div class="card" style="max-width: 900px; width: 800px;">
                      ...
                      <div class="card-body card-block">
                        <form action="actions/cadastrar_agendamento_ligacao.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                           ...
                           if(!empty($_GET['nomemodelo'])){
                            ...
                            <!--
                            <button type="button" class="btn btn-secondary mb-1" data-toggle="modal" data-target="#mediumModal" style="background: transparent; border: none;"><img src="images/abrircliente.png" width="32px" height="32px"> </button> <small>Pesquisar Cliente</small>
                            
                            <a href="pesquisar_cliente.php"><button type="button" class="btn btn-secondary mb-1" style="background: transparent; border: none;"><img src="images/abrircliente.png" width="32px" height="32px"> </button> Pesquisar Cliente</small></a>
                            </div>-->
                          </div>
                      ...
                      <div class="card-footer">
                        ...
                        <?php             
                                ...
                                $inserir_agendamento = "INSERT INTO agendamentos (data_agendada_agendamento, hora_agendada_agendamento, data_cadastro_agendamento, id_cliente, id_status_sistema, id_func, id_comparecimento) VALUES ('$data_agendamento_ajuste','$horaagendamento',NOW(),'$id_new_cliente','1','$idfuncionario','3') ";
