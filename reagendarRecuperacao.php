                ...
                <div class="col-lg-6">
                    <div class="card" style="max-width: 900px; width: 800px;">
                      <div class="card-header" style="max-width: 900px; width: 800px;">                        
                        <strong>Reagendar</strong> Cliente   - &nbsp;&nbsp;&nbsp;&nbsp; <a href="listaRecuperacaoAgendamento.php"><img src="../images/back.png" width="30px" height="30px"></a>
                      ...
                      <div class="card-body card-block"> 
                        ...
                        ?> 
                        <form action="actions/actReagendarClienteRecuperacao.php?ag=<?php echo $_GET['ag']; ?>&cli=<?php echo $_GET['cli']; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
