                ...
                <div class="col-lg-6">
                    <div class="card" style="max-width: 900px; width: 800px;">
                      <div class="card-header" style="max-width: 900px; width: 800px;">
                        ...
                        -->
                        <strong>Solicitar</strong> Análise de Duplicidade em Agendamento                        
                      </div>
                      <div class="card-body card-block">
                        <form action="actions/act_solicitar_analise_duplicidade_insta.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label"></label></div>
                            <div class="col-12 col-md-9"><input type="checkbox" id="text-input" name="ciencia" placeholder="" class="form-control" value="">Estou ciente desta solicitação de duplicidade tendo a possibilidade da mesma ser rejeitada pelo meu supervisor.<small class="form-text text-muted"></small></div>
                          </div>
                            <div class="row form-group">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              <select name="select_conta" id="select" class="form-control">
                                <?php 
                                    $result_contas_insta = "SELECT id_conta_utilizada, nome_conta_utilizada FROM conta_utilizada WHERE id_func = '$idfuncionario' "; 
