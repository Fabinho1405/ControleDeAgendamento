                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        ...
                        <?php       
                            ...
                            INNER JOIN status_auditoria sa ON agend.id_status_auditoria = sa.id_status_auditoria
                            WHERE agend.id_func = '$idfuncionario'AND agend.id_meio_captado = '1' ORDER BY id_agendamentos DESC LIMIT $inicio, $qnt_result_pg ";
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        ?>"><?php  echo date('d/m/Y', strtotime($row_agendamento['data_agendada_agendamento']));;
                            ?></td>                           
                        <td style="<?php 
                        if($reagendado == 1){
                            echo "background-color: #F0E68C;";
                        ...
                        ?>" title="TESTE">
                            <?php echo $row_agendamento['descricao_status_auditoria'];  ?>
                        </td>                                               
                        <td style="<?php 
                        if($reagendado == 1){
                            echo "background-color: #F0E68C;"; 
                        ...
                        ?>"><?php   $data_cadastro = $row_agendamento['data_cadastro_agendamento'];
                            echo date('d/m/Y', strtotime($data_cadastro)); ?> </td>
                      </tr>
                    </tbody>
                    <?php
                        };
