                ...
                <div class="col-lg-6">
                    <div class="card" style="max-width: 900px; width: 800px;">
                      ...
                      <div class="card-body card-block">
                        <form action="actions/act_encaminha_modelo_estudio.php?cn=<?php echo $id_cliente ?>" method="post" enctype="multipart/form-data" class="form-horizontal">              
                           ...
                           <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"> 
                              ...
                              <select name="motivo_encaminhamento" id="select" class="form-control">
                                <?php 
                                    $result_produtor = "SELECT * FROM motivo_estudio WHERE click=1"; 
                      ...
                      <div class="card-footer">
                        <button type="submit" name="btn_cadastro_agendamento" class="btn btn-primary btn-sm">
                          <i class="fa fa-dot-circle-o"></i> Encaminhar Para Estúdio
                        </button>
                        </form>
                      </div>
                    </div>
