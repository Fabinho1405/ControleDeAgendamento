...
<!--  INICIO PAGE  -->
        ...
        $max_links = 10;
        echo "<a href='visualizar_agendamento_ligacao.php?pagina=1'>Primeira</a> ";
        
        for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
            if($pag_ant >= 1){
                echo "<a href='visualizar_agendamento_ligacao.php?pagina=$pag_ant'>$pag_ant</a> ";
            }
        }
        ...
        for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
            if($pag_dep <= $quantidade_pg){
                echo "<a href='visualizar_agendamento_ligacao.php?pagina=$pag_dep'>$pag_dep</a> ";
            }
        }
        
        echo "<a href='visualizar_agendamento_ligacao.php?pagina=$quantidade_pg'>Ultima</a>";
