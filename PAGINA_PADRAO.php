        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Scouter</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Agendamentos</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-laptop"></i><a href="cadastrar_agendamento.php">Cadastrar Agendamento</a></li>
                            <li><i class="fa fa-laptop"></i><a href="verificar_situacao.php">Verificar Situação</a></li>
                            <li><i class="fa fa-laptop"></i><a href="todos_agendamentos.php">Todos os Agendamentos</a></li>
                            <li><i class="fa fa-laptop"></i><a href="notificar_gestor.php">Notificar Gestor</a></li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                                ...
                                <a class="nav-link" href="#"><i class="fa fa -cog"></i>Script</a>
