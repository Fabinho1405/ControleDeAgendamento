                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <?php
                                $numero_fichas_aguardando = "SELECT * FROM controle_ligacao WHERE id_func = '$idfuncionario' AND id_status_sistema = '1' AND liberado_controle_externo = '0' AND TIMESTAMPDIFF(HOUR, ultimo_fedback, NOW()) < 10 AND date(data_liberada_stand_by) <> date(NOW())";
                                ...
                                $numero_fichas_liberadas = "SELECT * FROM controle_ligacao WHERE `id_func` = '$idfuncionario' AND `id_extracao` = '0' AND liberado_controle_externo = '0' AND id_status_sistema = '1' AND date(data_liberada_stand_by) <> date(NOW())"; 
                    ...
                    <thead>
                      <tr>
                        ...
                        <?php  
                            ...
                            $result_usuarios = "SELECT * FROM controle_ligacao WHERE id_func = '$idfuncionario' AND id_status_sistema = '1' AND id_extracao = '0' AND liberado_controle_externo = '0' AND TIMESTAMPDIFF(HOUR, ultimo_fedback, NOW()) > 10 AND date(data_liberada_stand_by) <> date(NOW()) ORDER BY qtd_feedback ASC LIMIT 1";                            
