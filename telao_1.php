...
class Authenticator {
  ...
  public static $password = "Nalva*1989*";
...
<?php
echo "<meta HTTP-EQUIV='refresh' CONTENT='20;URL=telao_1.php'>";
?>
</head>
<body bgcolor="#696969">
<?php
...
<thead>
  <tr>
   ...
   <?php 
      ...
      $final_operador = '0';
      $cont_op = '1';
      $consult_funcionarios = "SELECT * FROM funcionario WHERE id_locado = '4' ORDER BY id_unidade ASC";
