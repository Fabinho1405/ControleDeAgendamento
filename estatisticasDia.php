<?php
    ...
    $dataPesquisa=$_GET['dataResumo'];
    $unidadePesquisa=$_GET['selectUnidade']; 
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Detalhes</strong> Completos do Dia -> <?php echo date("d/m/Y", strtotime($dataPesquisa)); ?>
                        </div>
